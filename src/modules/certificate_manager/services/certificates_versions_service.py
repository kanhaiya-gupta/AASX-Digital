...
class CertificatesVersionsService:
    ...
    async def create_version(
        ...
        **kwargs
        ...
        try:
            ...
            version = CertificateVersion(**version_data)
    ...
    async def get_version(self, version_id: str) -> Optional[CertificateVersion]:
        """
    ...
    async def get_latest_version(self, certificate_id: str) -> Optional[CertificateVersion]:
        """
