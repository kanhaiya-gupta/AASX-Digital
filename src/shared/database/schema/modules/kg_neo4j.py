...
class KgNeo4jSchema(BaseSchemaModule):
    """
    KG Neo4j Schema Module
    ...
    def create_tables(self) -> bool:
        ...
        if self._create_kg_graph_registry_table():
        ...
        if self._create_kg_neo4j_ml_registry_table():
        ...
        if self._create_kg_graph_metrics_table():
    ...
    def _create_kg_graph_registry_table(self) -> bool:
        ...
        # Create the table
        if not self.create_table("kg_graph_registry", query):
            return False
        ...
        return self.create_indexes("kg_graph_registry", index_queries)

    def _create_kg_neo4j_ml_registry_table(self) -> bool:
        ...
        # Create the table
        if not self.create_table("kg_neo4j_ml_registry", query):
            return False
        ...
        return self.create_indexes("kg_neo4j_ml_registry", index_queries)

    def _create_kg_graph_metrics_table(self) -> bool:
        ...
        # Create the table
        if not self.create_table("kg_graph_metrics", query):
            return False
        ...
        return self.create_indexes("kg_graph_metrics", index_queries)
