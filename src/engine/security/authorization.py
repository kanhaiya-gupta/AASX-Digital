...
class AuthorizationManager(ABC):
    ...
    def get_all_role_permissions(self, role_name: str) -> List[Permission]:
        ...
        inherited_roles = self.get_inherited_roles(role_name)
    ...
    def check_permission_base(self, context: SecurityContext, 
                             resource: str, action: str) -> AuthorizationResult:
        ...
        for role_name in user_roles:
            ...
            if role:
                ...
                inherited_permissions = self.get_all_role_permissions(role_name)
...
class RoleBasedAccessControl(AuthorizationManager):
    ...
    def check_permission(self, context: SecurityContext, 
        ...
        result = self.check_permission_base(context, resource, action)
    ...
    def get_user_permissions(self, user_id: str) -> List[Permission]:
        ...
        for role_name in user_roles:
            role_permissions = self.get_all_role_permissions(role_name)
