/**
 * Authentication Permissions Management Module
...
export default class AuthPermissions {
        ...
        this.roleDefinitions = {
            admin: {
                ...
                permissions: [
                    ...
                    'aasx:read', 'aasx:write', 'aasx:delete',
                    'physics:read', 'physics:write', 'physics:delete',
            ...
            manager: {
                ...
                permissions: [
                    ...
                    'aasx:read', 'aasx:write',
                    'physics:read', 'physics:write',
            ...
            user: {
                name: 'User',
                description: 'Basic user access and project viewing',
                permissions: [
                    'project:read',
                    'aasx:read',
                    'physics:read',
     ...
     */
    async init() {
        console.log('🔒 Initializing Permissions Management...');
        ...
        try {
            ...
            console.log('✅ Permissions Management initialized');

        } catch (error) {
            console.error('❌ Permissions Management initialization failed:', error);
            throw error;
        }
    }
